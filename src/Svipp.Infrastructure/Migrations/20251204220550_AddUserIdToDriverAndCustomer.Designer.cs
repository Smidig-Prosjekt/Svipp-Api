...
namespace Svipp.Infrastructure.Migrations
{
    ...
    [Migration("20251204220550_AddUserIdToDriverAndCustomer")]
    partial class AddUserIdToDriverAndCustomer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Svipp.Domain.Assignments.Vehicle", b =>
                {
                    ...
                    b.Property<string>("TrunkDimensions")
                        .HasColumnType("text");

                    b.Property<int?>("TrunkVolumeLiters")
                        .HasColumnType("integer");
